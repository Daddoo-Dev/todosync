...
async function handleCheckoutSessionCompleted(event: StripeEvent, supabase: any): Promise<boolean> {
...
async function handleSubscriptionChange(event: StripeEvent, supabase: any): Promise<boolean> {
...
async function handleSubscriptionDeleted(event: StripeEvent, supabase: any): Promise<boolean> {
  const subscription = event.data.object;
  const customerId = subscription.customer;
...
async function handlePaymentSucceeded(event: StripeEvent, supabase: any): Promise<boolean> {
...
async function handlePaymentFailed(event: StripeEvent, supabase: any): Promise<boolean> {
  const invoice = event.data.object;
  const customerId = invoice.customer;
